...
import org.vkulinski.demolot.repository.DemoTaskRepository;
...
import static org.vkulinski.demolot.domain.DrawStatus.*;
import static org.vkulinski.demolot.service.DemoDrawServiceImplTest.DATASET;
...
public class DemoDrawServiceImplTest {
    ...
    public void deleteByIdMustFailWithNonExistingId() {
        ...
        expectedException.expectMessage("Unable to find org.vkulinski.demolot.domain.Demo with id 4");
        //when
