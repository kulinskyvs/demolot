...
<main role="main" id="mainContainer">
  ...
  <div class="jumbotron">
    <div class="container">
      ...
      <p><a class="btn btn-primary btn-lg" href="/draws" role="button">Start playing &raquo;</a></p>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p><a class="btn btn-secondary" href="/draws" role="button">Start a draw &raquo;</a></p>
      </div>
    </div>
